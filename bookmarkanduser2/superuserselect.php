...
<div class ="title" style="background-color: #213e3b; height:90px;margin-bottom:40px;margin-left:10px;color:white;">
...
<!-- 説明 -->
<div class="explain" style="border:1px solid #213e3b;text-align:center;width:30%;margin:auto;margin-top:80px;">
  <h3>スーパー管理者画面利用説明</h3>
  <ul>
        ...
        <?php
            ...
            if ($status == false) {
              ...
              while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                echo '<thead><tr>';
                echo '<th class="first">管理者タイプ</th><th class="second">お名前</th><th class="third">ID</th><th class="fourth">パスワード</th><th class="fourth">入社状況</th><th class="fifth">&nbsp;</th>' ; 
                echo '</tr></thead>';
                echo '<tbody>';
                ...
                echo '<td>';
                echo "<button style='background-color:#e7e7de;border:none;' ><a style='text-decoration:none;color:black;' href=superedit.php?id=" . $result["id"] .">編集</a></button>\n";
                echo '<button style="background-color:#e7e7de;border:none;" >';
                echo "<a class='deletebutton' style='text-decoration:none;color:black;' href=superdelete.php?id=" . $result["id"] ." οnclick='javascript:return warning()'>削除</a>";
                echo '</button>';
                echo '</td>';
                echo '</tr>';  
                echo '</tbody>';
