...
$stmt->bindValue(':lpw', h($password), PDO::PARAM_STR);        //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':kanri_flg', h($type), PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
